...
- **System design:** [`docs/system/README.md`](docs/system/README.md). Schema, SoD types, data layers, cache. Sync law: [`docs/sync.md`](docs/sync.md). GRDB, not SwiftData. HealthKit samples never enter sqlite, iCloud, or push payloads. Views call `AppModel.submit`; only `SyncEngine` hits the network. Server settles fights. `scripts/check-sync-boundaries.py` greps this on every PR.
...
Details: [docs/product.md](docs/product.md) · [docs/backlog.md](docs/backlog.md) · [docs/shipping.md](docs/shipping.md) · [docs/history.md](docs/history.md) · [docs/system/README.md](docs/system/README.md) · [docs/sync.md](docs/sync.md) · [docs/design/source/README.md](docs/design/source/README.md)
