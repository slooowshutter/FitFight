...
- **Partner prize for most steps.** Same family as company-sponsored credits, but the prize is a month (membership / product) from a partner brand, for the people who walk the most. Marc’s example: a partnership like SysRife / a learning zone, and other companies in that shape. Not designed. Do not invent a screen.
