...
**Last TestFlight:** 27 Aug 2026 — unstick “Couldn’t load your account”: Sign out on that screen, and create the profile if Auth signed you in without one. Look for `0.9.0 · build N · staging`.
