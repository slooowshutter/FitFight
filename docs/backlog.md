...
- **Easy invite + join mid-month (prorate).** Marc walks Paris / Station F and asks people to beta. Send an invite (link or code). They download, use the app, and can join a challenge session. People will not start the same day. One idea: a monthly window (1st through the last day). Join halfway through: prorate — pay half, and if they place they only take half of a full-month win. Someone who ran the whole month (e.g. finishes 2nd) still gets a full-month share. Exact invite flow and ranking not designed. Do not invent a screen.
