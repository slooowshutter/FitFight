...
**Last TestFlight:** 30 Aug 2026 — signed resumable Apple Health uploads, large initial archives, useful sync failure reasons, and best-effort background delivery. Still `0.9.0`. Look for `0.9.0 · build N · staging`.
