...
**Last TestFlight:** 27 Aug 2026 — staging host `zstzbfocunthczzubggz`. Look for `0.9.0 · build N · staging`.
...
- Marc: one Steps fight on staging. Username, Apple Health, Start **once**. Add a friend by username on You.
