...
- **Goal-matched pairing.** Pair people who want the same kind of goal (sport, stay accountable). You do not have to know them. Messaging is optional: default is no DMs, just a match so you encourage each other toward the goal. If there is a chat, it can be fully anonymous like Reddit. Match on similar people / similar goals. Not a screen yet; do not invent one.
