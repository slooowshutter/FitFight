...
- Feed is one list of posts from every fight you’re in. Each post has a badge for the fight. Tap + to write a note and pick one or more fights next to photo or video. **All fights** selects every fight. Inside a fight, the same + posts there and does not ask where. There is no Public or Main destination. A tag does not add someone to a fight they are not in. Posts can take any emoji and nested comments.
