...
- Settings keeps Privacy, Support, Requests, Versions, Sign out, and Delete account. Look is Night or Day.
- Delete account removes the full account, uploaded Steps, memberships, posted requests, and owned fights; a stored Sign in with Apple authorization is revoked when available.
- Money, unsupported metrics, and dead settings are removed.
