...
The living list is [`backlog.md`](backlog.md). Right now the screens are a design-accurate mock with fixture people. No HealthKit, no backend, no notifications. Don’t invent the gaps listed in [`design/source/INVENTORY.md`](design/source/INVENTORY.md). Types from raw source → UI: [`architecture.md`](architecture.md).
