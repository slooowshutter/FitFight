...
- Companion: Change animal opens the animal grid. Make it yours opens one description to edit and save. The prepared Generate images screen creates an avatar, five fitness poses from a saved avatar, or a group photo from two to five of your saved avatars. It shows credits, resumes interrupted actions, automatically saves Blend image URLs to the account without copying the files, and lets you choose an avatar or fitness pose as your companion. Generation remains disabled on staging until configuration and rollout are complete. Automatic pose switching and group-photo assignment to fights are not part of this change.
