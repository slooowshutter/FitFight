...
- Apple Health sends merged Steps totals for active Fights. With permission, FitFight also imports accessible merged daily movement history and workout summaries into a private activity pipeline. Individual HealthKit samples stay on the phone. Other activity types are not Fight options yet.
