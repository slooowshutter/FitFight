...
| Companion | Saved on the account. The chosen animal is the avatar other people see in fights, standings, Feed, and comments. Tapping one shows five effort poses; weekly movement changes the scene. Hiking goat has real rest-to-peak art. Sport, breed, mood, and accessories stay on this iPhone. People who have not chosen an animal are asked the next time they open a build that includes this. Custom generation is not built. |
