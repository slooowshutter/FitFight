...
Freeze is PR #65: finished Fights and completed civil days stay put; the phone cannot mark a Fight `final` or write `complete_through`. Marc still needs to tap Delete account once on staging. Two-phone Steps proof (invite, matching standings, fight close) is still worth doing if it has not been proven.
