...
## Fighter copy: prepared 17 Sep 2026

**Code:** live copy calls the animals fighters, not companions. The picker
title is Choose your fighter in English and Choisis ton guerrier in French.
Save fighter, save errors, the You accessibility label, and the custom-animal
subtitle follow the same naming. Internal types, `companion_id`, and the
