...
- **Staging**: a long-lived persistent branch of the production Supabase project, with fake/test Users, stable branch credentials, staging OAuth callbacks, and staging secrets.
- **Production**: the main Supabase project in **US East (North Virginia)** with real Users, production OAuth callbacks, and production secrets.
