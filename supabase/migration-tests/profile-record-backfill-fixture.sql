...
insert into public.fights(id, owner_id, name, state, starts_at, ends_at, time_zone, outcome_rule, goal_policy) values
    ...
    ('72000000-0000-4000-8000-000000000004', '71000000-0000-4000-8000-000000000001', 'Future accepted round', 'scheduled', now() + interval '2 days', now() + interval '3 days', 'UTC', 'highest_total', 'shared');
...
where fight.id in ('72000000-0000-4000-8000-000000000001', '72000000-0000-4000-8000-000000000002', '72000000-0000-4000-8000-000000000003', '72000000-0000-4000-8000-000000000004')
