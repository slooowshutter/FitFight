        ...
        <main className="legal-page" lang="fr">
            <header className="legal-header">
                ...
                >
                    ...
                    <Link href="/fr/support" aria-current="page">
                        Assistance
                    </Link>
                </nav>
            </header>
            ...
            <article className="legal-content">
                ...
                <p className="legal-intro">
                    Écrivez-nous en indiquant votre nom d’utilisateur FitFight,
                    la version affichée en haut de l’écran et une courte
                ...
                <p className="support-safety">
                    N’envoyez jamais votre mot de passe Apple, votre code de
                    vérification ni vos données Santé d’Apple brutes.
                </p>
                ...
                <section>
                    ...
                    <p>
                        ...
                        quotidiens utiles aux graphiques. Les mises à jour en
                        arrière-plan dépendent d’iOS et peuvent ne pas être
                        immédiates.
                    </p>
                    <p>
                        Pour révoquer l’accès, retirez FitFight dans Santé
                        d’Apple ou les Réglages iOS. Votre score peut rester
                        incomplet après la révocation.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        ...
                        toujours écrire à l’assistance pour un compte ou un
                        problème Santé.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        Saisissez son nom d’utilisateur FitFight exact lors de
                        la création d’un défi. Cette personne doit d’abord se
                        connecter avec Apple et choisir un nom d’utilisateur.
                ...
                <section>
                    ...
                    <p>
                        FitFight compare le nombre de pas fusionné par Santé
                        d’Apple sur la même période exacte pour chaque
                        participant. Ouvrez l’app pour actualiser les pas. Les
                        pas effectués après l’heure de fin ne comptent pas dans
                        le résultat.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        ...
                        publiés, vous retire des défis créés par d’autres
                        personnes et supprime pour tous les participants les
                        défis que vous avez créés. FitFight demande aussi à
                        Apple de révoquer tout identifiant Connexion avec Apple
                        disponible, puis vous déconnecte. Cette action est
                        irréversible.
                    </p>
                    <p>
                        Si la révocation Apple automatique était indisponible,
                        suivez le message affiché dans l’app pour déconnecter
                        FitFight dans les Réglages de l’iPhone. Si la
                        suppression échoue, réessayez puis écrivez à
                        l’assistance depuis l’adresse liée à votre compte.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        ...
                        <Link href="/fr/privacy">
                            politique de confidentialité FitFight
                        </Link>
                        pour en savoir plus sur les données du compte, les défis
                        privés, les pas de Santé d’Apple, les prestataires et la
                        suppression.
                    </p>
                </section>
            </article>
