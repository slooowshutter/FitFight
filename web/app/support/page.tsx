...
export const metadata: Metadata = {
    ...
    description:
        "Get help with FitFight accounts, Apple Health Steps, Fight invitations, synchronization, and deletion.",
        ...
        <main className="legal-page">
            ...
            <article className="legal-content">
                ...
                <p className="legal-intro">
                    Email us with your FitFight username, the app version shown
                    at the top of the screen, and a short description of what
                    happened.
                </p>
                <a
                ...
                <p className="support-safety">
                    Never send your Apple ID password, verification code, or raw
                    Apple Health data.
                </p>
                ...
                <section>
                    ...
                    <p>
                        ...
                        Steps for your active Fight windows and the relevant
                        daily totals shown in Fight charts; background updates
                        depend on iOS and may not be immediate.
                    </p>
                    <p>
                        To revoke access, remove FitFight in Apple Health or iOS
                        Settings. Your score may remain incomplete after access
                        is removed.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        Enter their exact FitFight username when creating a
                        Fight. They must first sign in with Apple and choose a
                        username. The invitation then appears in their Fights
                        list for acceptance.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        FitFight compares Apple Health&apos;s merged Step Count
                        over the same exact Fight window for every participant.
                        Open the app to refresh current Steps. Steps that occur
                        after the Fight&apos;s end time do not count toward its
                        result.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        ...
                        created by someone else, and deletes Fights you created
                        for every participant. FitFight also asks Apple to
                        revoke an available Sign in with Apple credential and
                        signs you out. This cannot be undone.
                    </p>
                    <p>
                        If automatic Apple revocation was unavailable, follow
                        the message in the app to disconnect FitFight in iPhone
                        Settings. If deletion itself fails, retry and email
                ...
                <section>
                    ...
                    <p>
                        Read the{" "}
                        <Link href="/privacy">FitFight Privacy Policy</Link> for
                        details about account data, private Fights, Apple Health
                        Steps, service providers, and deletion.
                    </p>
                </section>
            </article>
