    ...
    return (
        <ol className="install-steps">
            ...
            <li>
                ...
                After TestFlight is on your iPhone, come back and open this same
                link a second time. That second tap is what adds FitFight.
            </li>
            <li>
                <strong>You do not need a code.</strong> If TestFlight asks for
                a redemption code, you skipped the second tap. Close that screen
        ...
        <section>
            ...
            <p>
                <strong>
                    ...
                    message and tap that original FitFight link again.
                </strong>{" "}
                Sign in to continue with your referral or challenge. You still
