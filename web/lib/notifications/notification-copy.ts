...
const socialKinds = ["feed_post", "post_comment", "comment_reply", "post_reaction"] as const;
...
export function socialNotificationAlert(
  ...
  const bodies: Record<(typeof socialKinds)[number], Record<NotificationLocale, string>> = {
    feed_post: {
