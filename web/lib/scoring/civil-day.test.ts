...
test("civil day stamps follow the fight time zone", () => {
    assert.equal(
        civilDayStamp(new Date("2026-09-02T03:30:00.000Z"), "America/New_York"),
        "2026-09-01",
    );
    assert.equal(
        civilDayStamp(new Date("2026-09-02T04:00:00.000Z"), "America/New_York"),
        "2026-09-02",
    );
    assert.equal(
        civilDayStamp(new Date("2026-09-02T00:00:00.000Z"), "UTC"),
        "2026-09-02",
    );
});
