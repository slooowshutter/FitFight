...
export const appleAuthorizationRequestSchema = z
    .object({
...
export type AppleSignInEnvironment = z.infer<
    typeof appleSignInEnvironmentSchema
>;
export type EncryptedAppleRefreshToken = z.infer<
    typeof encryptedAppleRefreshTokenSchema
>;
