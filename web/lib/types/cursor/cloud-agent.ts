...
export const fitFightGithubRepoUrl =
...
export const cursorAgentWebhookStatusSchema = z.enum(
    cursorAgentWebhookStatusValues,
);
...
export type CursorCreateAgentResponse = z.infer<
    typeof cursorCreateAgentResponseSchema
>;
export type CursorApiError = z.infer<typeof cursorApiErrorSchema>;
export type CursorAgentWebhookStatus = z.infer<
    typeof cursorAgentWebhookStatusSchema
>;
