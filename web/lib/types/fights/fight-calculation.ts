...
export const outcomeRuleValues = [
    "highest_total",
    "proportional",
    "hit_your_goal",
] as const;
...
export type FightCalculationMember = z.infer<
    typeof fightCalculationMemberSchema
>;
export type FightCalculationSnapshot = z.infer<
    typeof fightCalculationSnapshotSchema
>;
