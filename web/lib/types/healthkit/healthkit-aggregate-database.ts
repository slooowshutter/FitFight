...
export const healthKitAggregateFightSchema = fightCalculationRowSchema
    .pick({
        starts_at: true,
        ends_at: true,
        outcome_rule: true,
...
export type HealthKitAggregateSource = z.infer<
    typeof healthKitAggregateSourceSchema
>;
export type HealthKitAggregateFight = z.infer<
    typeof healthKitAggregateFightSchema
>;
export type HealthKitAggregateMember = z.infer<
    typeof healthKitAggregateMemberSchema
>;
