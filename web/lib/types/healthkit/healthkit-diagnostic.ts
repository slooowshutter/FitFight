...
export const healthKitDeliveryRegistrationStatusValues = [
    "enabled",
    "unavailable",
] as const;
export const healthKitSyncTriggerValues = [
    "observer",
    "foreground",
    "manual",
] as const;
...
export const healthKitSyncOutcomeValues = [
    "succeeded",
    "failed",
    "cancelled",
] as const;
...
export const healthKitServerTimingSchema = z
    .object({
...
export const healthKitSyncErrorSchema = z
    .object({
...
export const healthKitSyncStageSchema = z
    .object({
...
export const healthKitSyncAttemptSchema = z
    .object({
...
export const healthKitDiagnosticSnapshotSchema = z
    .object({
        background_refresh_status: z.enum(
            healthKitBackgroundRefreshStatusValues,
        ),
        delivery_registration_status: z.enum(
            healthKitDeliveryRegistrationStatusValues,
        ),
        ...
        last_trigger_context: z
            .enum(healthKitSyncTriggerValues)
            .nullable()
            .default(null),
        error_code: z
            .enum(healthKitSyncErrorCodeValues)
            .nullable()
            .default(null),
...
export const healthKitDiagnosticSnapshotResponseSchema = z
    .object({
        updated_at: z.string().datetime({ offset: true }),
    })
    .strict();

export type HealthKitDiagnosticSnapshot = z.infer<
    typeof healthKitDiagnosticSnapshotSchema
>;
