...
const canonicalUuidV4Schema = uuidV4Schema.transform((value) =>
    value.toLowerCase(),
);
...
export const createProviderUploadSchema = z
    .object({
...
export const providerArchiveRecordSchema = z
        ...
        if ("starts_at" in value) {
            ...
            if (
                ...
                context.addIssue({
                    ...
                    message: permitsEqual
                        ? "ends_at precedes starts_at"
...
export const providerFightWindowStateValues = [
    "live",
    "awaiting_final_sync",
] as const;
...
export type ProviderFightWindowRow = z.infer<
    typeof providerFightWindowRowSchema
>;
